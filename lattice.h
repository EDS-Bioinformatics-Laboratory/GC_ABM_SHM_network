...
public:
    ...
    lattice(parameters& p, string  CXCL12fname, string  CXCL13fname); // Function that takes parameters and builds the grid
    string print();
...
public:
    ...
    vector <vector3D> fdcposes;
    vector3D get_fdc_position(int j);
    void set_initial_fdc_position();
